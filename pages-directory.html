...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Directory | Upcube - Admin & Dashboard Template</title>
                            ...
                            <div class="col-lg-4">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">Ralph L. Alva</h5>
                                                <p class="text-muted font-size-14">Webdeveloper</p>
                            ...
                            <div class="col-lg-4">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">John B. Roman</h5>
                                                <p class="text-muted font-size-14">Webdeveloper</p>
                            ...
                            <div class="col-lg-4">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-5.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">James M. Caviness</h5>
                                                <p class="text-muted font-size-14">Webdeveloper</p>
                            ...
                            <div class="col-lg-4">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-6.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">Peter F. Costanzo</h5>
                                                <p class="text-muted font-size-14">Webdeveloper</p>
                            ...
                            <div class="col-lg-4">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-1.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">Lewis S. Cruz</h5>
                                                <p class="text-muted font-size-14">Webdeveloper</p>
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">Thomas C. Wheeler</h5>
                                                <p class="text-muted font-size-14">Webdeveloper</p>
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">David O. Buckley</h5>
                                                <p class="text-muted font-size-14">Webdeveloper</p>
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-5.jpg" alt="Generic placeholder image">
                                            <div class="flex-grow-1">
                                                <h5 class="mt-0 font-size-18 mb-1">Johnny W. Seitz</h5>
                                                <p class="text-muted font-size-14 mb-2">Webdeveloper</p>
